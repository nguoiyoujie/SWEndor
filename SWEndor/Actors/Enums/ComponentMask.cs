...
namespace SWEndor.Actors
{
  ...
  public enum ComponentMask
  {
    ...
    LASER_PROJECTILE = CAN_RENDER | CAN_MOVE | IS_DAMAGE | CAN_COLLIDE | CAN_EXPLODE,
    MISSILE_PROJECTILE = CAN_RENDER | CAN_MOVE | CAN_ROTATE | IS_DAMAGE | CAN_BETARGETED | CAN_COLLIDE | CAN_EXPLODE,
