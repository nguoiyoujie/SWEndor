...
namespace SWEndor.UI
{
  public class UIPage_FatalError : UIPage
  {
    ...
    public UIPage_FatalError(Exception exception)
    {
      ...
      MainText.TextFont = Font.GetFont("Text_24").ID;
      ...
      Instructions.TextFont = Font.GetFont("Text_12").ID;
