...
namespace SWEndor.UI.Widgets
{
  public class HitBar : Widget
  {
    ...
    {
      ActorInfo m_target = Owner.Engine.ActorFactory.Get(Owner.Engine.PlayerInfo.AimTargetID);
      ...
      float barlength = Owner.Engine.ScreenWidth * 0.75f - 100;
      ...
      TVScreen2DImmediate.Draw_FilledBox(50
                                        , Owner.Engine.ScreenHeight - 25
                                        , barlength + 50
                                        , Owner.Engine.ScreenHeight - 20
