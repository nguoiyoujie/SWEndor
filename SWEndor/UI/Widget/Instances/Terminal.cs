...
namespace SWEndor.UI.Widgets
{
  public class WidgetTerminal : Widget
  {
    ...
    public override void Draw()
    {
      ...
      TVScreen2DImmediate.Draw_FilledBox(loc.x - 5, loc.y - 5, Owner.Engine.ScreenWidth - 5, Owner.Engine.ScreenHeight - 5, new TV_COLOR(0, 0, 0, 0.5f).GetIntColor());
      ...
      TVScreen2DText.TextureFont_DrawText(TConsole.InputLine
        , loc.x, Owner.Engine.ScreenHeight - loc.y - 40f / 3f, new TV_COLOR(1, 1, 1, 1).GetIntColor(), Font.Factory.Get("Text_08").ID);
