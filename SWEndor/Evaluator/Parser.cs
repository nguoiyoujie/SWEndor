...
namespace SWEndor.Evaluator
{
  ...
  public partial class Parser
  {
    ...
    private void ParseStart(ParseNode parent) // NonTerminalSymbol: Start
    {
      ...
      // Concat Rule
      tok = scanner.LookAhead(TokenType.IF, TokenType.FUNCTION, TokenType.VARIABLE, TokenType.BOOLEANLITERAL, TokenType.DECIMALINTEGERLITERAL, TokenType.HEXINTEGERLITERAL, TokenType.REALLITERAL, TokenType.STRINGLITERAL, TokenType.BRACKETOPEN, TokenType.PLUS, TokenType.MINUS, TokenType.NOT, TokenType.ASSIGN); // Option Rule
    ...
    private void ParseIfThenElseStatement(ParseNode parent) // NonTerminalSymbol: IfThenElseStatement
    {
      Token tok;
      ParseNode n;
      ParseNode node = parent.CreateNode(scanner.GetToken(TokenType.IfThenElseStatement), "IfThenElseStatement");
      parent.Nodes.Add(node);
      ...
      parent.Token.UpdateRange(node.Token);
    } // NonTerminalSymbol: IfThenElseStatement
    ...
    private void ParseFunction(ParseNode parent) // NonTerminalSymbol: Function
    {
      ...
      // Concat Rule
      tok = scanner.LookAhead(TokenType.IF, TokenType.FUNCTION, TokenType.VARIABLE, TokenType.BOOLEANLITERAL, TokenType.DECIMALINTEGERLITERAL, TokenType.HEXINTEGERLITERAL, TokenType.REALLITERAL, TokenType.STRINGLITERAL, TokenType.BRACKETOPEN, TokenType.PLUS, TokenType.MINUS, TokenType.NOT, TokenType.ASSIGN, TokenType.SEMICOLON); // Option Rule
      if (tok.Type == TokenType.IF
          || tok.Type == TokenType.FUNCTION
          || tok.Type == TokenType.VARIABLE
          || tok.Type == TokenType.BOOLEANLITERAL
    ...
    private void ParsePrimaryExpression(ParseNode parent) // NonTerminalSymbol: PrimaryExpression
    {
      ...
      tok = scanner.LookAhead(TokenType.IF, TokenType.FUNCTION, TokenType.VARIABLE, TokenType.BOOLEANLITERAL, TokenType.DECIMALINTEGERLITERAL, TokenType.HEXINTEGERLITERAL, TokenType.REALLITERAL, TokenType.STRINGLITERAL, TokenType.BRACKETOPEN); // Choice Rule
      switch (tok.Type)
      { // Choice Rule
        case TokenType.IF:
          ParseIfThenElseStatement(node); // NonTerminal Rule: IfThenElseStatement
          break;
    ...
    private void ParseUnaryExpression(ParseNode parent) // NonTerminalSymbol: UnaryExpression
    {
      ...
      tok = scanner.LookAhead(TokenType.IF, TokenType.FUNCTION, TokenType.VARIABLE, TokenType.BOOLEANLITERAL, TokenType.DECIMALINTEGERLITERAL, TokenType.HEXINTEGERLITERAL, TokenType.REALLITERAL, TokenType.STRINGLITERAL, TokenType.BRACKETOPEN, TokenType.PLUS, TokenType.MINUS, TokenType.NOT); // Choice Rule
      switch (tok.Type)
      { // Choice Rule
        case TokenType.IF:
        case TokenType.FUNCTION:
    ...
    private void ParseExpression(ParseNode parent) // NonTerminalSymbol: Expression
    {
      ...
      // Concat Rule
      tok = scanner.LookAhead(TokenType.IF, TokenType.FUNCTION, TokenType.VARIABLE, TokenType.BOOLEANLITERAL, TokenType.DECIMALINTEGERLITERAL, TokenType.HEXINTEGERLITERAL, TokenType.REALLITERAL, TokenType.STRINGLITERAL, TokenType.BRACKETOPEN, TokenType.PLUS, TokenType.MINUS, TokenType.NOT); // Option Rule
      if (tok.Type == TokenType.IF
          || tok.Type == TokenType.FUNCTION
          || tok.Type == TokenType.VARIABLE
          || tok.Type == TokenType.BOOLEANLITERAL
