...
{
  public class ValFunc<T1, T2, T3, T4, T5, T6, T7, T8> : IValFunc
  {
    Func<Context, T1, T2, T3, T4, T5, T6, T7, T8, Val> F;
    public ValFunc(Func<Context, T1, T2, T3, T4, T5, T6, T7, T8, Val> fn) { F = fn; }
