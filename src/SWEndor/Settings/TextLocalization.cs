...
namespace SWEndor
{
  public enum TextLocalKeys
  {
    ...
    ACTORTYPE_INITWICE_ERROR,
    EXPLTYPE_INVALID_ERROR,
    EXPLTYPE_INITWICE_ERROR,
    PROJTYPE_INVALID_ERROR,
    PROJTYPE_INITWICE_ERROR,
    DERBTYPE_INVALID_ERROR,
    DERBTYPE_INITWICE_ERROR,
  ...
  public static class TextLocalization
  {
    static Dictionary<TextLocalKeys, string> keys = new Dictionary<TextLocalKeys, string>
    {
      ...
      { TextLocalKeys.DERB_OVERFLOW_ERROR, "Number of current debris exceeded limit of {0}!" },
      { TextLocalKeys.DERB_INVALID_ERROR, "Attempted to register debris with null DebrisType!" },

      { TextLocalKeys.ACTORTYPE_INVALID_ERROR, "ActorType '{0}' does not exist" },
      { TextLocalKeys.ACTORTYPE_INITWICE_ERROR, "Attempted to load ActorType '{0}' twice!" },
      { TextLocalKeys.EXPLTYPE_INVALID_ERROR, "ExplosionType '{0}' does not exist" },
      { TextLocalKeys.EXPLTYPE_INITWICE_ERROR, "Attempted to load ExplosionType '{0}' twice!" },
      { TextLocalKeys.PROJTYPE_INVALID_ERROR, "ProjectileType '{0}' does not exist" },
      { TextLocalKeys.PROJTYPE_INITWICE_ERROR, "Attempted to load ProjectileType '{0}' twice!" },
      { TextLocalKeys.DERBTYPE_INVALID_ERROR, "DebrisType '{0}' does not exist" },
      { TextLocalKeys.DERBTYPE_INITWICE_ERROR, "Attempted to load DebrisType '{0}' twice!" },
