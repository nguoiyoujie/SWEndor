...
namespace SWEndor.ExplosionTypes.Instances
{
  internal class ExpW01 : Groups.Explosion
  {
    internal ExpW01(Factory owner) : base(owner, "EXPW01", "ExpW01")
    {
      ...
      ExplRenderData = new ExplRenderData(1, 1, 2, 100);

      MeshData = MeshDataDecorator.CreateHorizon(Engine, Name, 50, Path.Combine("explosion", "wave", @"tex0000.jpg"), CONST_TV_BLENDINGMODE.TV_BLEND_ADDALPHA);
    }
  }
}
