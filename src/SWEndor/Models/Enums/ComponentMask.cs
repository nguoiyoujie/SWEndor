...
namespace SWEndor.Models
{
  ...
  public enum ComponentMask
  {
    ...
    LASER_PROJECTILE = CAN_RENDER | CAN_MOVE | CAN_COLLIDE | CAN_EXPLODE,
    GUIDED_PROJECTILE = CAN_RENDER | CAN_MOVE | CAN_ROTATE | CAN_BETARGETED | CAN_COLLIDE | HAS_AI | CAN_EXPLODE,
