...
namespace SWEndor.Game.Scenarios
{
  public class GSMainMenu : ScenarioBase
  {
    ...
    public void Empire_TIEDefender()
    {
      ...
      List<TV_3DVECTOR> positions = new List<TV_3DVECTOR>
      {
        new TV_3DVECTOR(-10500, -1010, State.MinBounds.z - 7500),
        new TV_3DVECTOR(-10250, -910, State.MinBounds.z - 7600),
        new TV_3DVECTOR(-10750, -910, State.MinBounds.z - 7600)
      };
    ...
    public void Empire_TIEAvengers()
    {
      ...
      List<TV_3DVECTOR> positions = new List<TV_3DVECTOR>
      {
        new TV_3DVECTOR(-9500, -560, State.MinBounds.z - 6500),
        new TV_3DVECTOR(-9250, -660, State.MinBounds.z - 6600),
        new TV_3DVECTOR(-9750, -660, State.MinBounds.z - 6600)
      };
