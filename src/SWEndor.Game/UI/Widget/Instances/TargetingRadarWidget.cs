...
{
  public class TargetingRadarWidget : Widget
  {
    private readonly TV_2DVECTOR targetingradar_center;
    private readonly float targetingradar_radius;

    public TargetingRadarWidget(Screen2D owner) : base(owner, "targetingradar")
    {
