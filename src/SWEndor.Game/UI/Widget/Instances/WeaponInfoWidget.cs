...
{
  public class WeaponInfoWidget : Widget
  {
    // Left Info
    private readonly float leftinfo_left = 20;
    private readonly float leftinfo_weapontop = 50;
    private readonly float leftinfo_weaponwidth = 95;
    private readonly float leftinfo_weaponheight = 40;

    public WeaponInfoWidget(Screen2D owner) : base(owner, "weapon") { }
