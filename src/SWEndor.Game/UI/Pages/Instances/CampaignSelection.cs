...
namespace SWEndor.Game.UI.Menu.Pages
{
  public class CampaignSelection : Page
  {
    ...
    readonly SelectionElement DescText = new SelectionElement();
    readonly SelectionElement NameText = new SelectionElement();
    readonly List<SelectionElement> ChoiceText = new List<SelectionElement>();

    readonly SelectionElement ButtonPrev = new SelectionElement();
    readonly SelectionElement ButtonNext = new SelectionElement();
    readonly SelectionElement ButtonBack = new SelectionElement();
